; REQUIRES: asserts
; RUN: llc < %s -mtriple=wasm32-unknown-unknown -mcpu=mvp -mtune=u2-sysv -wasm-tune-stackify=false -debug-only=wasm-reg-stackify -o /dev/null 2>&1 | FileCheck %s --check-prefix=DISABLED
...
; DISABLED-LABEL: Function: dot7_plus_fast
; DISABLED-NOT: wasm-tune-stackify: choose-action
