...
define double @dot7_plus_strict(double %z, double %a0, double %b0,
                                double %a1, double %b1, double %a2,
                                double %b2, double %a3, double %b3,
                                double %a4, double %b4, double %a5,
                                double %b5, double %a6, double %b6) {
entry:
  ...
  %p6 = fmul double %a6, %b6
  %s01 = fadd double %p0, %p1
  %s012 = fadd double %s01, %p2
  %s0123 = fadd double %s012, %p3
  %s01234 = fadd double %s0123, %p4
  %s012345 = fadd double %s01234, %p5
  %s0123456 = fadd double %s012345, %p6
  %r = fadd double %s0123456, %z
  ret double %r
}
...
; U2-LABEL: Function: dot7_plus_strict
